...
{
    public partial class ReportBarang011 : Form
    {
        public ReportBarang011()
        {
            InitializeComponent();
        }

        private void ReportBarang011_Load(object sender, EventArgs e)
        {
        ...
        public void exportgridtoexcel(DataGridView dgw, string filename)
        {
            ...
            saveFileDialogeExcel.FileName = "Quiz Mahasiswa";
        ...
        private void btnExportintoPDF_Click(object sender, EventArgs e)
        {
            exportgridtopdf(dataGridView1, "Quiz Mahasiswa");
        }

        private void btnExportintoExcel_Click(object sender, EventArgs e)
        {
            exportgridtoexcel(dataGridView1, "Quiz Mahasiswa");
        }
    }
}
